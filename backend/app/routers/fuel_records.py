...
def create_fuel_record(
    ...
    response = FuelRecordResponse(
        ...
        refuel_datetime=created.refuel_datetime,
        total_mileage=created.total_mileage,
        fuel_type=created.fuel_type,
        unit_price=created.unit_price,
        total_cost=created.total_cost,
        is_full_tank=created.is_full_tank,
        gas_station_name=created.gas_station_name,
...
def update_fuel_record(
    ...
    updated = service.update_fuel_record(
    ...
    response = FuelRecordResponse(
        ...
        refuel_datetime=updated.refuel_datetime,
        total_mileage=updated.total_mileage,
        fuel_type=updated.fuel_type,
        unit_price=updated.unit_price,
        total_cost=updated.total_cost,
        is_full_tank=updated.is_full_tank,
        gas_station_name=updated.gas_station_name,
        distance_traveled=None,
        fuel_amount=None,
        fuel_efficiency=None,
...
def delete_fuel_record(
    ...
    if not deleted:
        ...
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND, detail="燃費記録が見つかりません"
        )
